...
<head>
    <meta charset="utf-8">
    <title>JASSDAK - Jassdak Facility Services Pvt. Ltd.</title>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght" rel="stylesheet"> 
...
<body>
        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <img class="w-50" src="Jassdak Logo-02.png" alt="Image">
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="pricing.html" class="nav-item nav-link">Careers</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Media</a>
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                <a href="blog.html" class="dropdown-item">Gallary</a>
    ...
    <!-- Page Header Start -->
    <div class="page-header container-fluid bg-secondary pt-2 pt-lg-2 pb-2 mb-6">
        <div class="container py-5">
            <div class="row align-items-center py-4">
                <div class="col-md-6 text-center text-md-left">
                    <h1 class="mb-4 mb-md-0 text-white">Videos</h1>
                </div>
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        <a class="btn text-white" href="">Home</a>
                        <i class="fas fa-angle-right text-white"></i>
                        <a class="btn text-white disabled" href="">Videos</a>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href=""><h6 class="text-white mb-1"><img class="w-100" src="Jassdak Logo white-04.png" alt="Image">
                </a> 
                <br>
                <p>We are an integrated Facility Management Company with strong presence in different states of India Our skilled, experience motivation and dedicated personel have a person track record of acgieving high client satisfaction.</p>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-map-marker-alt mr-2"></i>FID,DDA Flats, munirka New Delhi- 110067</p>
                <p><i class="fa fa-phone-alt mr-2"></i>+91 8586869558
                </p>
                <p><i class="fa fa-envelope mr-2"></i>jassdakindia@jassdak.com</p>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Career</a>
    ...
    <div class="container-fluid bg-dark text-white py-4 px-sm-3 px-md-5">
        <p class="m-0 text-center text-white">
            &copy; <a class="text-white font-weight-medium" href="#">Your Web Site Designed by</a>. EIBO Services Pvt Ltd
